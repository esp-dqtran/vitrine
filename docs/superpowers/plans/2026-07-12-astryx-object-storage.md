...
- [x] **Step 1: Write failure-first tests for each write path**
...
- [x] **Step 2: Use deterministic server-generated keys**
...
- [x] **Step 3: Replace canonical and legacy capture writes**
...
- [x] **Step 4: Replace bulk import and caption reads**
...
- [x] **Step 5: Persist export and failure artifacts**
