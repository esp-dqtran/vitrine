...
import { Button, Card, EmptyState } from '@astryxdesign/core';
...
export function CuratorReviewPanel({ app, platform, snapshot }: { app: string; platform: Platform; snapshot: DesignSystemSnapshot<EvidenceView> | null }) {
  ...
  if (!working) return <EmptyState title="No design system to review" description="Generate a working design system before opening curator review." />;
