...
test('validates the database palette response', () => {
  const palettes = parseColorPalettes({ items: defaultColorPalettes });
  assert.equal(palettes.length, 58);
