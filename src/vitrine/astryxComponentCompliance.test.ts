...
const allowedNativeControls = {
  ...
  'components/CatalogComponentsPage.tsx': { button: 6 },
  ...
  'components/ColorPaletteComposer.tsx': { button: 21, input: 2 },
  'components/ColorPostStudioPage.tsx': { button: 13, input: 1 },
  'components/CommandPalette.tsx': { button: 1 },
  'components/ComponentLibraryPreview.tsx': { button: 26, input: 3, select: 1 },
  'components/ContentArchitectureLivePreview.tsx': { button: 1 },
  ...
  'components/ReconstructedButtonComponents.tsx': { button: 2 },
