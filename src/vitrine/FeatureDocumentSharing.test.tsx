...
const share: PublicFeatureDocumentShare = {
  ...
  revision: {
    revisionNumber: 5, reviewStatus: 'approved',
    ...
    content: {
      ...
      requirements: [{ ...claim('req', 'Preserve progress'), userStory: 'As a buyer, I want to resume checkout.', priority: 'must', preconditions: ['Checkout started'], acceptanceCriteria: [{ id: 'ac', given: 'started', when: 'interrupted', then: 'restore', evidenceIds: ['IMAGE-42'] }] }],
