...
function TasteStackCard({ animationUrl, animationData, title, copy }) {
  ...
  return (
    <article className="taste-stack-card">
      <div className="taste-stack-card__animation" aria-hidden="true">
        <DotLottieReact {...(animationData ? { data: animationData } : { src: animationUrl })} autoplay loop />
      </div>
    ...
    <section className="taste-stack" aria-label="Taste across the stack">
      ...
      <div className="taste-stack__grid">
        <TasteStackCard
          ...
          animationData={trainingAnimationData}
        ...
        <TasteStackCard
          ...
          animationData={agentsAnimationData}
