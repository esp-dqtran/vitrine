...
export function DesktopMenuCard({
  ...
  const menu = (
      <div className={`desktop-menu ${framed ? "" : className}`.trim()}>
        <ul className="desktop-menu__links">
          <li className="desktop-menu__home-item">
            ...
            >
              <ContentArchitectureLogo className="desktop-menu__logo" />
            </a>
          </li>
          ...
          {links.map((link) => (
            <li className="desktop-menu__item" key={link.key}>
              <a
                ...
                href={link.href}
                aria-current={link.key === currentKey ? "true" : undefined}
  ...
  return framed ? <div className={`desktop-menu-frame ${className}`.trim()}>{menu}</div> : menu;
}
